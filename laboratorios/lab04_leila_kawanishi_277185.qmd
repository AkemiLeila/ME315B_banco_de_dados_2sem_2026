...
countries <- countries %>% 
  filter(`Short Name` %in% c("Brazil", "Nigeria", "Georgia", "Japan", "Fiji")) %>% 
...
```{r}
#WDI nao está em formato tidy porque a variavel ano esta distribuída em colunas. Vamos usar o pivot_longer
...
```{r}
#Como no glimpse acima, "YEAR" esta em formato character. Vamos transforma em inteiro
